...
package Carthage.Combat is
   ...
   function Weapon
     (Attack : Attack_Record)
      return Carthage.Handles.Units.Weapon_Category;
...
private
   ...
   package Asset_Vectors is
     new Ada.Containers.Vectors
       (Positive, Carthage.Handles.Assets.Asset_Handle, Hira.Asset."=");

   package Stack_Vectors is
     new Ada.Containers.Vectors
       (Positive, Carthage.Handles.Stacks.Stack_Handle, Hira.Stack."=");
